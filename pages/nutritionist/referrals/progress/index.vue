                              ...
                              <div class="col-lg-12 col-md-12 col-12">
                                <section class="mb-50">
                                  ...
                                  <div class="card">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="product-name">1. Ogunduboye Johnson</td>
                                        <td>
                                          <nuxt-link
                                            to="/nutritionist/referrals/progress/progressadmin"
                                      ...
                                      <tr>
                                        <td class="product-name">2. Chioma Ciroma</td>
                                        <td>
                                          <nuxt-link
                                            to="/nutritionist/referrals/progress/progressadmin"
                                            class="btn btn-sm btn-primary float-right"
                                      ...
                                      <tr>
                                        <td class="product-name">3. Halita Idrees</td>
                                        <td>
                                          <nuxt-link
                                            to="/nutritionist/referrals/progress/progressadmin"
                                            class="btn btn-sm btn-primary float-right"
                                      ...
                                      <tr>
                                        <td class="product-name">4. Ahmed Haruna</td>
                                        <td>
                                          <nuxt-link
                                            to="/nutritionist/referrals/progress/progressadmin"
                                            class="btn btn-sm btn-primary float-right"
