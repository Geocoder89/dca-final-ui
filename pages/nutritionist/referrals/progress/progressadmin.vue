                        ...
                        <div class="card-body pb-0">
                          ...
                          <div class="tab-content pt-1">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                              ...
                              <h6 class="text-center"><strong>Treatments</strong></h6>
                              <div class="col-lg-12 col-md-12 col-12">
                                <section class="mb-50">
                                    <div class="card">
                                  <div class="card-header pl-0 mb-1">
                              ...
                              <div class="row justify-content-center">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-6 align-self-center">
                                            <h4 class="float-right">Upload Results:</h4>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-6">
                                            <nuxt-link to="#" class="btn btn-primary text-center float-left" style="background-color:#89878B !important;">Upload</nuxt-link>
                                        </div>
                                   
                              </div>
                              <div class="col-12 text-center mt-2">
                                   <nuxt-link to="#" class="btn btn-primary text-center" style="background-color:#89878B !important;">Cancel</nuxt-link>
                                <nuxt-link to="#" class="btn btn-primary text-center">Send Result</nuxt-link>
                              </div>
