                        ...
                        <div class="card-body pb-0">
                          ...
                          <div class="tab-content pt-1">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                              ...
                              <div class="col-12">
                                <h6 class="mb-1">Test Result (if any):</h6>
                                <h6 class="mb-1">Prescription (if any):</h6>
                                <nuxt-link to="/nutritionist/referrals/new/medicaladmission" class="btn btn-primary" style="background-color:#89878B !important;">nutritionist Medical Report</nuxt-link>
                              </div>
