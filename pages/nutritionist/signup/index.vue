                    ...
                    <div class="card rounded-0 mb-0 p-2">
                      <div class="card-header pt-50 pb-1">
                        <div class="card-title">
                          <h4 class="mb-0">NUTRITIONIST REGISTRATION</h4>
                        </div>
                      </div>
                      <p class="px-2">
                            ...
                            <form action="">
                              <div class="row">
                                ...
                                <div class="col-xl-12 col-md-12 col-12 mb-0">
                                  <fieldset class="form-group">
                                    <label for="basicInput">Description of nutritionist:</label>
                                    <textarea
                                      id="basicInput"
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 pl-0">
                                <p>
                                  ...
                                  <nuxt-link to="/nutritionist/login">login</nuxt-link>
                                </p>
                                <nuxt-link to="/nutritionist/verify" style="border-radius:40px;" class="btn btn-primary">
                                  Register</nuxt-link
                                >
                              </div>
                            </form>
