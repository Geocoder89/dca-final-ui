                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                          <h6>ambulance Info</h6>
                            <hr>
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-12">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><strong>Registered Name:</strong> Bay Hills</li>
                                    <li class="list-group-item"><strong>License Ops No:</strong> xxxxxx955f</li>
                        ...
                        <div class="col-12">
                          <nuxt-link to="/ambulance/editprofile" class="btn btn-outline-primary mt-2">
...
<script>
import Header from '~/components/ambulance/header'
import Footer from '~/components/ambulance/footer'
