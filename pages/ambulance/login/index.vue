                                            ...
                                            <div class="card-body pt-1">
                                                <form action="index.html">
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="text-left">
                                                             <div class="text-right d-sm-block"><nuxt-link to="/ambulance/forgotpassword" class="card-link">Forget Password?</nuxt-link></div>
                                                        </div>
                                                    </div>
                                                   <!--  <a href="index.html" class="btn btn-outline-primary float-left btn-inline">Register</a> -->
                                                    <nuxt-link to="/ambulance/dashboard" type="submit" id="login" class="btn btn-primary d-block btn-inline" style="border-radius:40px;">Sign In</nuxt-link>
                                                </form>
                                                <div class="form-group d-flex justify-content-between align-items-center mt-2">
                                                        <div class="text-center">
                                                             <div class="text-right d-sm-block">Don't Have an Account?<nuxt-link to="/ambulance/signup" class="card-link"> Create Account</nuxt-link></div>
                                                        </div>
                                                </div>
                                            </div>
                                        </div>
