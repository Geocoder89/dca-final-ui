                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                            ...
                            <div class="row">
                              <div class="col-lg-6 col-md-6 col-12">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><strong>Registered Name:</strong> Don Mils</li>
                                    <li class="list-group-item"><strong>License:</strong> xxxxxx955f</li>
                                    <li class="list-group-item"><strong>Adresss:</strong> 13, odetola street</li>
                        ...
                        <div class="col-12">
                            <nuxt-link to="/diagnostic/editprofile" class="btn btn-outline-primary mt-2">
