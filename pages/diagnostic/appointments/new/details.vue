                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <section class="mb-50">
                                    <div class="card">
                                      ...
                                      <h6><strong>Tosin has booked an appointment with your hospital</strong></h6>
                                      <h6><strong>Date:</strong> 01-05-2020</h6>
                                      <h6><strong>Time:</strong> 01:30 PM</h6>
                                    </div>
                                  </div>
                                </section>
                              </div>
                              <div class="col-12 text-center mt-2">
                                 <nuxt-link to="#" class="btn btn-primary text-center">Accept</nuxt-link>
                                   <nuxt-link to="#" class="btn btn-danger text-center" style="">Reject</nuxt-link>
                              </div>
                            </div>
