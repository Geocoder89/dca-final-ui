                ...
                <div class="col-md-6 col-lg-6">
                  ...
                  <div class="card">
                    <table class="table data-list-view">
                      <tbody>
                        <tr>
                          <td class="product-name">New Requests <sup>(3)</sup></td>
                          <td>
                            <nuxt-link
                              to="/nurse/bookings/new"
                        ...
                        <tr>
                          <td class="product-name">Pending Requests <sup>(2)</sup></td>
                          <td>
                            <nuxt-link
                              to="/nurse/bookings/pending"
                              class="btn btn-primary float-right"
                              >View</nuxt-link
                            >
                          </td>
                        ...
                        <tr>
                          <td class="product-name">Completed Cases<sup>(5)</sup></td>
                          <td>
                            <nuxt-link
                              to="/nurse/bookings/completed"
                              class="btn btn-primary float-right"
                              >View</nuxt-link
                            >
                          </td>
