                          ...
                          <div class="tab-content pt-1">
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                              ...
                              <div class="col-lg-12 col-md-12 col-12">
                                <section class="mb-50">
                                  ...
                                  <div class="card-header pl-0 mb-1">
                                    ...
                                    <div class="card-body" style="background:#F8F8F8;border-radius:20px;">
                                        <p>
                                            23, Adewale Obeme Crescent, Maryland Lagos Nigeria.
                                        </p>
                                    </div>
                                  </div>
                                </section>
                              ...
                              <div class="col-lg-12 col-md-12 col-12">
                                <section class="mb-50">
                                  ...
                                  <div class="card-header pl-0 mb-1">
                                    ...
                                    <div class="card-body" style="background:#F8F8F8;border-radius:20px;">
                                        <p>
                                            <strong>Name: </strong>Wale Adenuga
                                        </p>
                                        <p>
                                            <strong>Phone: </strong>09089786767
                                        </p>
                                        <p>
                                            <strong>Address: </strong>testmail@gmail.com
                                        </p>
                                    </div>
                                  </div>
                                </section>
                              ...
                              <div class="col-12 d-flex justify-content-center">
                                  <muxt-link to="#" class="btn btn-primary">
                                      Confirm Request
                                  </muxt-link>
                              </div>
