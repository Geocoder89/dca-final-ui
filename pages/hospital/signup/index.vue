                            ...
                            <form action="">
                              <div class="row">
                                ...
                                <div class="col-xl-12 col-md-12 col-12 mb-0">
                                  <fieldset class="form-group">
                                    <label for="basicInput">Description of Hospital:</label>
                                    <textarea
                                      id="basicInput"
                                      style="resize:none;"
                                      class="form-control">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12 pl-0">
                                <p>
                                  ...
                                  <nuxt-link to="/hospital/login">login</nuxt-link>
                                </p>
                                <nuxt-link to="/hospital/verify" style="border-radius:40px;" class="btn btn-primary">
                                  Register</nuxt-link
                                >
                              </div>
                            </form>
