                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                              ...
                              <div class="row justify-content-center">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-6">
                                            <nuxt-link to="/hospital/referrals/completed/treatment" class="btn btn-primary text-center float-left" style="background-color:#89878B !important;">View</nuxt-link>
                                        </div>
