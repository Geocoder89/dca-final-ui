      ...
      <div class="main-menu-content">
        ...
        >
          <li class="nav-item active">
            <nuxt-link to="/nutritionist/dashboard"
          ...
          <hr />
          <li class=" nav-item">
            <nuxt-link to="/nutritionist/profile"
              ><ion-icon
                name="person-outline"
          ...
          <li class=" nav-item">
            <nuxt-link to="/nutritionist/referrals"
              ><ion-icon
                name="people-outline"
                style="margin-right:1em;"
              ></ion-icon>
          ...
          <li class=" nav-item ">
            <nuxt-link to="/nutritionist/appointments"
          ...
          <li class=" nav-item">
            <nuxt-link to="/nutritionist/message"
        ...
        >
          <li class=" nav-item">
            <nuxt-link to="/nutritionist/help"
              ><ion-icon
          ...
          <li class=" nav-item">
            <nuxt-link to="/nutritionist/changepassword"
              ><ion-icon
