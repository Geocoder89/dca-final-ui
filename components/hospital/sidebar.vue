      ...
      <div class="main-menu-content">
        ...
        >
          <li class="nav-item active">
            <nuxt-link to="/hospital/dashboard"
          ...
          <li class=" nav-item">
            <nuxt-link to="/hospital/referrals"
              ><ion-icon name="people-outline"  color="dark" style="margin-right:1em;"></ion-icon>
              <span class="menu-title">Referrals</span>
            </nuxt-link>
          </li>
          <li class=" nav-item">
            <nuxt-link to="/hospital/appointments"
              ><ion-icon name="calendar-outline" color="dark" style="margin-right:1em;"></ion-icon>
              <span class="menu-title"> Appointment</span>
            </nuxt-link>
          </li>
          <li class=" nav-item ">
            <nuxt-link to="/hospital/message"
