        ...
        <div class="navbar-container content">
          <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              <li class="nav-item">
                <nuxt-link class="nav-link nav-link-label" to="/hospital/message"
              ...
              <li class="dropdown dropdown-user nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  <nuxt-link class="dropdown-item" to="/hospital/editprofile"
                    ><i class="feather icon-user"></i> Edit Profile</nuxt-link
                  >
                  <nuxt-link class="dropdown-item" to="/hospital/message"
