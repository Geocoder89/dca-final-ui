        ...
        >
          ...
          <li class=" nav-item ">
            <nuxt-link to="patients"
              ><ion-icon name="person-add-outline" color="dark" style="margin-right:1em;"></ion-icon>
